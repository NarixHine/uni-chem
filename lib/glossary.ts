...
export const glossary: GlossaryEntry[] = [
    ...
    },
    {
        ...
        definition:
            '**形式电荷**\n\n' +
            '形式电荷是在路易斯结构中，假设每个共价键的电子在两原子间**完全均分**（与电负性无关），由此算出的某个原子“账面上”带有的电荷。它只是一种电子计数工具，不反映原子实际带电多少。\n\n' +
            '$$\\text{形式电荷} = \\text{价电子数} - \\text{孤对电子数} - \\tfrac{1}{2}\\,\\text{成键电子数}$$\n\n' +
            '判断时：先画路易斯结构，数清原子的孤对电子和成键电子，再代入公式。电中性原子的形式电荷为 $0$；得失电子后，形式电荷等于所带净电荷。同一分子的不同路易斯结构中，各原子形式电荷越接近 $0$、负电荷越落在电负性较强原子上的结构越稳定。',
    },
    {
        term: '进攻',
        aliases: [],
